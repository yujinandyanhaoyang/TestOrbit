    ...
    <div class="header-main">
      ...
      <div class="brand-section">
        ...
        <div class="brand-info">
          ...
          <p class="brand-subtitle">智能协作 · 高效管理 · 数据驱动</p>
        </div>
      </div>
      ...
      <div class="status-indicators">
        <div class="indicator-item">
          ...
          <span class="indicator-label">{{ totalProjects }} 个项目</span>
        </div>
        <div class="indicator-separator"></div>
        <div class="indicator-item">
          <div class="indicator-dot syncing"></div>
          <span class="indicator-label">实时同步</span>
        </div>
      </div>
      ...
      <div class="action-zone">
        <div class="quick-actions">
          <!-- 搜索按钮 -->
          <button class="quick-btn search-btn" @click="$emit('filter')">
          ...
          <!-- 筛选按钮 -->
          <button class="quick-btn filter-btn" @click="$emit('filter')">
            <svg class="btn-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <!-- 主要行动按钮 -->
        <button class="premium-cta" @click="$emit('add-project')">
...
@media (max-width: 1024px) {
  .premium-card-header {
    ...
    .brand-section .brand-info .brand-title {
      font-size: 28px;
    }
  }
}
